...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // ── Placeholder: Gemini AI/OCR analysis will be implemented in the next phase ──
    // The GEMINI_API_KEY will be stored as a Supabase secret and accessed via:
    // const geminiApiKey = Deno.env.get("GEMINI_API_KEY");

    return new Response(
      JSON.stringify({
        status: "not_implemented",
        message: "AI/OCR analysis has not been implemented yet. This is a secure skeleton.",
